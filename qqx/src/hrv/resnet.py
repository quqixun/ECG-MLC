...
class ResNeXt(nn.Module):
    ...
    def __init__(self, in_channels=12, n_classes=55, kss=[13, 11, 9, 7, 5],
                 layers=[3, 3, 3, 3, 3], groups=8, dropout=0.5, hrv_feats=None):
        ...
        hrv_feats = 0 if hrv_feats is None else hrv_feats
        self.hrv_linear = nn.Linear(hrv_feats, 512, bias=True)
        self.linear = nn.Linear(feats + 512, n_classes, bias=True)
...
if __name__ == '__main__':
    ...
    summary(model, [(12, 2000), (1, 2212)], batch_size=256)
