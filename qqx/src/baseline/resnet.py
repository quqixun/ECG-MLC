...
class Res1DBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, inp=16, ks=3, stride=1,
        ...
        if groups == 1:
            ...
            ratio = planes / (inp * expansion)
            D = groups * int(inp * ratio)
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, in_channels=8, n_classes=55, kss=[7, 7, 5, 5, 3],
...
if __name__ == '__main__':
    ...
    model = ResNeXt()
    summary(model, (8, 1000), batch_size=128)
